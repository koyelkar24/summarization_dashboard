...
Video downloading (Whisper fallback) is disabled for cloud deployment to prevent 403 blocks.
"""
import re
import uuid
...
def fetch_youtube_transcript(url: str, progress_cb=None) -> dict:
    if progress_cb: progress_cb(20, "Connecting to YouTube via captions API...")
